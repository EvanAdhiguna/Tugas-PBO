...
public class Admin {
    ...
    public static void viewRestaurant() {
        ...
        for(String namaRestaurant : restaurantList.keySet()){
            ...
            for (Menu menu : restaurantList.get(namaRestaurant).getMenus()){
                System.out.printf("|| - %-25s - %-5s %n", menu.getNama(), menu.getHarga());
            }
            System.out.println("||------------------------------------------------------||");
        }
    }
    ...
    public static void viewMenu(){
        ...
        while(!menu.equals("2")){
            ...
            System.out.print("|| Masukan nomor menu yang dinginkan: ");
            ...
            System.out.println("\n");
            System.out.print("|| Apakah anda ingin menambah menu lagi ?  (1 = iya / 2 = tidak) : ");
            menu = scanner.next();
        }
        System.out.print("|| Masukan jarak lokasi anda dengan lokasi restoran (dalam km) : ");
    ...
    public static void addRestaurant() {
        ...
        System.out.println("|| Tambah restaurant telah berhasil! ||");
        System.out.println("\n");
    }
